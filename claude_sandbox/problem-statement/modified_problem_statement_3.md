...
- We will then discuss things via telegram voice notes and populate this section with clear instructions
...
After every attempt, you will use the "swarm" skill
